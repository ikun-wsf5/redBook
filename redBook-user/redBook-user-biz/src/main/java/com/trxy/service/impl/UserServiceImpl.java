...
import com.trxy.constants.RoleConstants;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public void updateUserInfo(UpdateUserInfoReqVO updateUserInfoReqVO) {
        ...
        if (StringUtils.isNotBlank(redBookId)) {
            Preconditions.checkArgument(ParamUtils.checkredBookId(redBookId), ResponseCodeEnum.RED_BOOK_ID_VALID_FAIL.getErrorMessage());
    ...
    @Override
    public FindUserByPhoneRspDTO findByPhone(FindUserByPhoneReqDTO findUserByPhoneReqDTO) {
        ...
        return findUserByPhoneRspDTO;
    }

    @Override
    public void updatePassword(UpdateUserPasswordReqDTO updateUserPasswordReqDTO) {
        // 获取当前请求对应的用户 ID
     ...
     */
    @Override
    public FindUserByIdRspDTO findById(FindUserByIdReqDTO findUserByIdReqDTO) {
    ...
    @Override
    public List<FindUserByIdRspDTO> findByIds(FindUsersByIdsReqDTO findUsersByIdsReqDTO) {
        // 需要查询的用户 ID 集合
        ...
        // 从数据库中批量查询
        List<UserDO> userDOS = userMapper.selectByIds(userIdsNeedQuery);
